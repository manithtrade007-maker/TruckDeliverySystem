          ...
          <nav ref={desktopNavRef} aria-label="Primary navigation" className="relative hidden w-full gap-1 overflow-auto rounded-2xl border border-slate-200 bg-slate-100 p-1 lg:flex lg:w-auto">
            ...
            {navItems.map(([key, label]) => (
              <button
                ...
                className={`relative z-10 whitespace-nowrap rounded-xl px-4 py-2 text-[15px] font-black transition-[color,background-color,transform] duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 motion-reduce:transform-none motion-reduce:transition-none ${
                  page === key
                    ? "text-white"
                    : "text-slate-700 hover:-translate-y-px hover:bg-white/80 hover:text-slate-950"
                }`}
              >
                {label}
              </button>
          ...
          {navItems.map(([key, label]) => {
            ...
            return (
              <button
                ...
                className={`flex min-w-0 flex-1 flex-col items-center justify-center gap-1 rounded-xl px-1 py-2 font-black transition-[color,background-color,transform] duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-teal-500 motion-reduce:transform-none motion-reduce:transition-none ${
              ...
              >
                ...
                <span className="truncate text-[10px] font-black leading-none">{label}</span>
              </button>
            );
          })}
        </div>
